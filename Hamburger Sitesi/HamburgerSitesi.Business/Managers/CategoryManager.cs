...
using HamburgerSitesi.Business.Services;
using HamburgerSitesi.Data.Entities;
using HamburgerSitesi.Data.Repositories;
using System;
...
namespace HamburgerSitesi.Business.Managers
{
    public class CategoryManager : ICategoryService
    {
        ...
        public bool AddCategory(AddCategoryDto addCategoryDto)
        {
            ...
            {
                return false;
                // Bu isimde kategori zaten mevcutsa, false
            }
        ...
        public List<ListCategoryDto> GetCategories()
        {
            ...
            // Her bir entity için, 1 adet ListCategoryDto new'leyip, veri aktarımı gerçekleştiriyorum ve listeye çeviriyorum.
